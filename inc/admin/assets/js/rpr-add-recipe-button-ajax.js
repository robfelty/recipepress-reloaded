...
(function ($) {
    ...
    rprRecipeSc = {
        ...
        init: function () {
            ...
            inputs.nonce = $('#rpr_recipe_button_ajax_nonce');
            // Secondary options
            ...
            //Action when a recipe is selected from the list...
        ...
        ajax: function (callback) {
            var self = this,
                query = {
                    ...
                    page: this.page,
                    rpr_recipe_button_ajax_nonce: inputs.nonce.val()
                };
            console.log(inputs.nonce.val());
