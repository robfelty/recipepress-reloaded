		...
		<div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="settings-page-wrap-title">
			...
			<div id="settings-page-wrap-content" class="modal__content">
				<form method="post" action="options.php">
					<?php settings_fields( 'rpr-author-box' ); ?>
					<?php do_settings_sections( 'rpr-author-box' ); ?>
					<div class="form-table">
						...
						<div>
							...
							<div>
								<input type="text"
									name="rpr_author_box_options[author_box_title]"
									id="author-box-title"
									class="regular-text"
							...
							<div>
								<div class="rpr-settings-text-group">
									<div class="rpr-settings-text-wrapper">
										<input type="text"
											name="rpr_author_box_options[facebook_color]"
											id="facebook-color"
						...
						<div>
							...
							<div>
								<div class="rpr-settings-text-group">
									<div class="rpr-settings-text-wrapper">
										<input type="text"
											name="rpr_author_box_options[twitter_color]"
											id="twitter-color"
											class="rpr-settings-text rpr-color-select"
						...
						<div>
							...
							<div>
								<div class="rpr-settings-text-group">
									<div class="rpr-settings-text-wrapper">
										<input type="text"
											name="rpr_author_box_options[pinterest_color]"
											id="pinterest-color"
											class="rpr-settings-text rpr-color-select"
						...
						<div>
							...
							<div>
								<div class="rpr-settings-text-group">
									<div class="rpr-settings-text-wrapper">
										<input type="text"
											name="rpr_author_box_options[instagram_color]"
											id="instagram-color"
											class="rpr-settings-text rpr-color-select"
					...
					<div>
						...
						<div>
							<div class="rpr-settings-text-group">
								<div class="rpr-settings-text-wrapper">
									<input type="text"
										name="rpr_author_box_options[yummly_color]"
										id="yummly-color"
										class="rpr-settings-text rpr-color-select"
					...
					<div>
						...
						<div>
							<div class="rpr-settings-text-group">
								<div class="rpr-settings-text-wrapper">
									<input type="text"
										name="rpr_author_box_options[linkedin_color]"
										id="linkedin-color"
										class="rpr-settings-text rpr-color-select"
