...
namespace Recipepress\Inc\Libraries\CSSTidy;

use Recipepress\Inc\Libraries\CSSTidy\Inc\CSSTidy_Optimise;
use Recipepress\Inc\Libraries\CSSTidy\Inc\CSSTidy_Print;
...
class CSSTidy {
    ...
    public function __construct() {
        $data = array();
        include __DIR__ . '/inc/data.inc.php';
        $this->data = $data;
